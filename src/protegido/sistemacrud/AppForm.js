  ...
  return (
    <div>
      ...
      <div className='form-group input-group'>
        ...
        <input type='text' className='form-control' name='nombre' placeholder='Nombre...' onChange={handleStatusChange} value={objeto.nombre} />
      </div>
      <div className='form-group input-group clearfix'>
        <div className='input-group-text bd-light' >
          <i className='material-icons'>star_half</i>
        </div>
        <input type='text' className='form-control float-start' name='edad' placeholder='Edad...' onChange={handleStatusChange} value={objeto.edad} />
      </div>
      <div className='form-group input-group'>
        <div className='input-group-text bd-light' >
          <i className='material-icons'>insert_link</i>
        </div>
        <input type='text' className='form-control float-start' name='genero' placeholder='Género...' onChange={handleStatusChange} value={objeto.genero} />
      </div>
      <button className='btn btn-primary btn-block'>
